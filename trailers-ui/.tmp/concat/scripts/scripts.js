...
angular.module('app.core').controller('ListMarketsController', ["marketsService", "$scope", "$location", function (marketsService, $scope, $location) {
...
angular.module('app.core').controller('ManageTheatersController', ["marketsService", "$routeParams", "theatersService", function (marketsService, $routeParams, theatersService) {
...
angular
  .module('app.services')
  .service('securityService', ["$http", function ($http) {
...
angular
  .module('app.services')
  .service('theatersService', ["securityService", function (securityService) {
...
angular
  .module('app.services')
  .service('marketsService', ["securityService", function (securityService) {
