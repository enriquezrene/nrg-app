...
angular.module('app.core').controller('ManageMarketsController', ["MarketsService", "FirebaseService", "$firebaseArray", "$http", function (MarketsService, FirebaseService, $firebaseArray, $http) {
...
angular.module('app.core').controller('ManageTheatersController', ["FirebaseService", "$firebaseArray", "MarketsService", function (FirebaseService, $firebaseArray, MarketsService) {
